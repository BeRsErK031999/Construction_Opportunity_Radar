...
| 9       | **ART-009 Vertical classifier and relevance rules** | Детерминированный baseline `CONSTRUCTION`, `HORECA`, `OTHER` по source metadata, словарям и правилам; AI получает только разрешённые и потенциально релевантные уникальные материалы.                                                                                     | ART-007–008          | `NEXT` |
