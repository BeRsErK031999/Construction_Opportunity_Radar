...
| 17      | **ART-017 Digest**                     | Daily top-5 и weekly summary строятся из compact recommendations, не raw news; порядок детерминирован, источники трассируются, повторная сборка не дублирует delivery.                                                                                                                                                                                                                                                          | ART-010, ART-014–016      | `NEXT`    |
