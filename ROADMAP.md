...
| 21      | **ART-021 Observability**                        | Единые structured events, correlation IDs и счётчики ingestion/pipeline/AI/delivery. Задача агрегирует уже добавляемую по ходу наблюдаемость; Grafana не обязательна.                                                             | ART-002, ART-013, ART-018     | `NEXT`     |
