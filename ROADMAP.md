...
| 18      | **ART-018 Durable jobs and scheduler** | Jobs `fetchSources`, `normalize`, `deduplicate`, `classify`, `analyze`, `buildDigest`, `deliverDigest`; transactional claim, no overlap, retry budget, stale-lock recovery, terminal failure и restart tests.                                                                                                                                                                                                                   | ART-004, ART-013, ART-017 | `NEXT`    |
