...
| 23      | **ART-023 Backup and restore**                   | Команды PostgreSQL backup/restore, зашифрованное/ограниченное хранение по среде и фактически проверенный restore с runbook.                                                                                                       | ART-004, ART-018, ART-022     | `NEXT`     |
