...
| Порядок | Задача                                 | Результат и проверяемый выход                                                                                                                                                                                 | Зависимости               | Статус    |
| ------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | --------- |
| 14      | **ART-014 Application API**            | Health, signals, sources, user profile и feedback endpoints; Zod validation, фильтры, authorization boundary и safe errors. Source Registry API не разрешает AI processing без прав.                          | ART-004, ART-013          | `NEXT` |
