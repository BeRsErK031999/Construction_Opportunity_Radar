...
| Порядок | Задача                                           | Результат и проверяемый выход                                                                                                                                                                                                     | Зависимости                   | Статус     |
| ------- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ---------- |
| 19      | **ART-019 Eval dataset**                         | 200 размеченных материалов, по 100 Construction и HoReCa, с relevance, category/event type, facts, expected action и importance. Fixtures и gold set разделены.                                                                   | ART-003, ART-005, ART-009–012 | `NEXT`     |
