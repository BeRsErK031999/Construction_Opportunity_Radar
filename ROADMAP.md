...
| 16      | **ART-016 Feedback loop**              | Завершить пользовательский outcome-контур для `ACTED` и `ALREADY_KNOWN`, reason/context и безопасного повторного взаимодействия; измеряемо свести HTTP/Telegram actions с recommendation/delivery/correlation и подготовить feedback read model.                                                                                                                                            | ART-014–015               | `NEXT`    |
