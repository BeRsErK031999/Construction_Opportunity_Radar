...
| 24      | **ART-024 CI**                                   | GitHub Actions выполняет frozen install, lint, typecheck, unit/integration test и build. DeepSeek, Telegram и production credentials отсутствуют; PostgreSQL поднимается только как test service.                                 | ART-002–023                   | `NEXT`     |
