...
| Порядок | Задача                              | Результат и проверяемый выход                                                                                                                                                                            | Зависимости      | Статус    |
| ------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | --------- |
| 11      | **ART-011 AI provider abstraction** | Порт `AIProvider` (`analyzeSignal`, `healthCheck`, `modelInfo`) не содержит Ollama-специфики; `FakeAIProvider` детерминированно возвращает валидный анализ и поддерживает управляемые ошибки для тестов. | ART-003, ART-010 | `NEXT` |
