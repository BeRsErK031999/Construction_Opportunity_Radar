...
| 8       | **ART-006 RSS/HTTP adapter**                        | Generic RSS и/или public HTTP adapter с timeout, bounded retry, rate limit, user-agent, provenance, timestamps и безопасными ошибками. Fixture tests не зависят от сети; live smoke разрешён только для одобренного источника.                                            | ART-005, ART-007–008 | `NEXT` |
