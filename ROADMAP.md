...
| 10      | **ART-010 Opportunity scoring**                     | Чистая versioned функция пяти факторов 0–100 с breakdown и порогами; `companyFit` вычисляется для профиля, а не хранится как глобальное свойство сигнала. Unit tests проверяют веса, границы и объяснение.                                                                | ART-003, ART-009     | `NEXT` |
